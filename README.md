...
[![NPM version](https://img.shields.io/npm/v/anchorbrowser.svg)](https://npmjs.org/package/anchorbrowser) ![npm bundle size](https://img.shields.io/bundlephobia/minzip/anchorbrowser)
...
```sh
npm install git+ssh://git@github.com:stainless-sdks/anchorbrowser-typescript.git
```

> [!NOTE]
> Once this package is [published to npm](https://app.stainless.com/docs/guides/publish), this will become: `npm install anchorbrowser`
...
We are keen for your feedback; please open an [issue](https://www.github.com/stainless-sdks/anchorbrowser-typescript/issues) with questions, bugs, or suggestions.
