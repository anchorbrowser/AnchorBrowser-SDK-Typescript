import fs from 'fs';
import type { ResponseLike } from 'anchorbrowser/internal/to-file';
import { toFile } from 'anchorbrowser/core/uploads';
...
describe('missing File error message', () => {
  ...
  test('is thrown', async () => {
    const uploads = await import('anchorbrowser/core/uploads');
    await expect(
