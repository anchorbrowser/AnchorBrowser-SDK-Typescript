...
export class APIConnectionError extends APIError<undefined, undefined, undefined> {
  constructor(input: { message?: string | undefined; cause?: Error | undefined });
}
...
export class APIPromise<T> extends Promise<T> {
  ...
  constructor(
    ...
    parseResponse?: (client: Anchorbrowser, props: APIResponseProps) => PromiseOrValue<T>,
  );
